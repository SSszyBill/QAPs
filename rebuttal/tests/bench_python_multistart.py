"""
bench_python_multistart.py — 对 QAPLIB 论文 16 个测试问题跑 Python 版
FW1 / FW100 / FW1000 / FW2000，并将结果写入独立 txt 文件。
...
OUTPUT_PATH = Path("/Users/shazhengyang/Code/FastApproximateQAP/rebuttal/results/qaplib_bench_python_multistart.txt")
IMAX = 30
RNG_SEED = 12345678
